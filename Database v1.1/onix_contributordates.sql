...
DROP TABLE IF EXISTS `contributordates`;
...
LOCK TABLES `contributordates` WRITE;
/*!40000 ALTER TABLE `contributordates` DISABLE KEYS */;
INSERT INTO `contributordates` VALUES (1,'12','20181010','2018-08-15 18:37:55','2018-08-15 18:37:55');
/*!40000 ALTER TABLE `contributordates` ENABLE KEYS */;
UNLOCK TABLES;
