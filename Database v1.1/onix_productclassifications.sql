...
DROP TABLE IF EXISTS `productclassifications`;
...
--
-- Dumping data for table `productclassifications`
--

LOCK TABLES `productclassifications` WRITE;
/*!40000 ALTER TABLE `productclassifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `productclassifications` ENABLE KEYS */;
UNLOCK TABLES;
