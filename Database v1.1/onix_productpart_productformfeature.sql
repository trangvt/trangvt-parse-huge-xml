...
DROP TABLE IF EXISTS `productpart_productformfeature`;
...
LOCK TABLES `productpart_productformfeature` WRITE;
/*!40000 ALTER TABLE `productpart_productformfeature` DISABLE KEYS */;
INSERT INTO `productpart_productformfeature` VALUES (1,2);
/*!40000 ALTER TABLE `productpart_productformfeature` ENABLE KEYS */;
UNLOCK TABLES;
